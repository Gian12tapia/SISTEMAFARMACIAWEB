...
namespace SistemaInventario.AccesoDatos.Inicializador
{
    public class DbInicializador : IDbInicializador
    {
        ...
        public void Inicializar()
        {
            ...
            {
                UserName = "Gianfranco123@gmail.com",
                Email = "Gianfranco123@gmail.com",
                EmailConfirmed = true,
                Nombres= "Gianfranco",
                Apellidos = "Tapia"
            ...
            UsuarioAplicacion usuario = _db.UsuarioAplicacion.Where(u => u.UserName == "Gianfranco123@gmail.com").FirstOrDefault();
